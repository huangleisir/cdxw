...
/*	public static void main(String[] args) {
		System.out.println("-----------");
		String stringA ="amount=1&cardNo=8807550010000035199&nonceStr=ibuaiVcKdpRxkhJA&outTradeNo=737411100011000101&password=510814";
		String signTemp=stringA+"&key=B83B3538A4431A4E8950DA741D6BAB1C";
		String sign=MD5Util.getMD5Str2(signTemp).toUpperCase();
 			String resultStr = HttpClientUtil.doPost("http://10.101.130.8:18187/prepaycard-front-dc/card/consume?"
 		+stringA+"&sign="+sign);
